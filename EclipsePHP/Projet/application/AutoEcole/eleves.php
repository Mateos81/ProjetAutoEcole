			...
			<!-- Entête première ligne du tableau de recherche de la page-->
				...
				<script language="JavaScript">
					...
					<?php
						...
						echo "<form action=\"consulterEleve.php\" method=\"post\">";
						/* Boucle affichage du tableau de la page*/
						for ($x = 0; $x < $TAILLE; $x++) {
							$_SESSION['Tableau'.$x] = serialize($Tableau[$x]);
						  echo "<tr>
                                    <td style=\"width:30px;\">
                                        <input type=\"checkbox\" name=\"eleve[]\" id=\"formule\" value=\"" . $x . "\" onclick=\"clickCheck(this);\" />
                                    </td>
                                    ...
                                    <td style=\"width:100px;\">" . $Tableau[$x]->getEleve_dateNaiss() . "</td>
									<td style=\"width:100px;\">" . $Tableau[$x]->getEleve_salarie() . "</td>
									<td style=\"width:100px;\">" . $Tableau[$x]->getEleve_client() . "</td>
                                </tr>";
						}
